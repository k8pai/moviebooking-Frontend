							...
							<CardContent>
								...
								<div className="coupon-container">
									...
									<div className="marginApply">
										<Button
											variant="contained"
											onClick={this.couponApplyHandler.bind(
												this,
											)}
											color="primary"
										>
								...
								<div className="coupon-container">
									...
									<div>
										{parseInt(this.state.totalPrice, 10)}
									</div>
								</div>
								<br />
